...
public class C02_BeforeClass_AfterClass {
    ...
    /*
        Bu gorevlerin saglikli olarak yapilmasi icin
        - test method'larinin dogru sirada calismasi gerekir
        - driver objesi tum method'lardan once olusturmali
          ve tum method'lar calistiktan sonra kapatilmalidir

        Bunu sagalayabilmek icin @BeforeClass ve @AfterClass kulaniriz
        ANCAK dikkat etmemiz gereken konu
        bu notasyonu kulanan method'lar static olmak zorundadir
    */
